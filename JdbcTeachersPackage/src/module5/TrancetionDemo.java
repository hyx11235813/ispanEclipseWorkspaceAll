...
public class TrancetionDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String sql2 = "insert into [user_table](id,userName,pwd) " + "values (?,?,?)";
			...
			pstmt.setInt(1, 1);
			pstmt.setInt(2, 10);
			pstmt.executeUpdate(); // 它是用來執行那些改變數據庫內容的 SQL 語句// int updateCount = pstmt.executeUpdate();//返回受影響的行數
